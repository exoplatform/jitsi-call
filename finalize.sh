...
# Need to setup $CALL_APP_URL and $EXTERNAL_JWT_SECRET as ENV variable before running
echo "[debug] CALL APP URL: $CALL_APP_URL" >> finalize.log
echo "[debug] EXO_JWT_SECRET: $EXO_JWT_SECRET" >> finalize.log
#Build JWT 
currentTime=$(date +%s)
